...
class Display:
    ...
    def __init__(self, Text):
        ...
        self.words = process_text(Text, excludewords)
    ...
    def webVersion(self):
        ...
        for word in self.words[:50]:
            ...
            if word[1] == 2:
                f.write(
                    """<div class="word" style="color:rgb(""" + colour_code + "," + colour_code_1 + "," + colour_code_2 + """);" id="small"><span class="tooltiptext">Frequency:""" + str(
                        word[1]) + """<p>Meaning:""" + str(dictionary.meaning(word[0])) + """</p></span>""" + word[
                        0] + """</div>""")
            elif word[1] >= 5:
                f.write(
                    """<div class="word" style="color:rgb(""" + colour_code + "," + colour_code_1 + "," + colour_code_2 + """);" id="huge"><span class="tooltiptext">Frequency:""" + str(
                        word[1]) + """<p>Meaning:""" + str(dictionary.meaning(word[0])) + """</p></span>""" + word[
                        0] + """</div>""")
            elif word[1] >= 4:
                f.write(
                    """<div class="word" style="color:rgb(""" + colour_code + "," + colour_code_1 + "," + colour_code_2 + """);" id="big"><span class="tooltiptext">Frequency:""" + str(
                        word[1]) + """<p>Meaning:""" + str(dictionary.meaning(word[0])) + """</p></span>""" + word[
                        0] + """</div>""")
            elif word[1] >= 3:
                f.write(
                    """<div class="word" style="color:rgb(""" + colour_code + "," + colour_code_1 + "," + colour_code_2 + """);" id="medium"><span class="tooltiptext">Frequency:""" + str(
                        word[1]) + """<p>Meaning:""" + str(dictionary.meaning(word[0])) + """</p></span>""" + word[
                        0] + """</div>""")
            else:
                f.write(
                    """<div class="word" style="color:rgb(""" + colour_code + "," + colour_code_1 + "," + colour_code_2 + """);" id="rest"><span class="tooltiptext">Frequency:""" + str(
                        word[1]) + """<p>Meaning:""" + str(dictionary.meaning(word[0])) + """</p></span>""" + word[
                        0] + """</div>""")
        f.write("""
            </div>
...
#
#     excludewords = stopwords.stopWords('stopwords.txt')
#     fwords = process_text(string_of_words, excludewords)
#
# if __name__ == '__main__':
#     dictionary=PyDictionary()
#
#     # try:
#     #     textData = GUI.fetchData()
#     #     words = main(textData)
#     # except:
#     #     pass
